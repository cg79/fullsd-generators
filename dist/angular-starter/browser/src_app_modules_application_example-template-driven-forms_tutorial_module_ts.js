(self["webpackChunkcondition_mongo_query"] = self["webpackChunkcondition_mongo_query"] || []).push([["src_app_modules_application_example-template-driven-forms_tutorial_module_ts"],{
...
const routes = [
    {
        path: '', component: _tutorial_component__WEBPACK_IMPORTED_MODULE_0__.TutorialComponent, children: [
            {
                path: '',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_application_example-template-driven-forms_00-main_exercice_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./00-main/exercice.module */ 5102))
                    .then(mod => mod.ExerciceModule)
            },
            {
                path: 'single',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_application_example-template-driven-forms_01-single_exercice_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./01-single/exercice.module */ 9003))
                    .then(mod => mod.ExerciceModule)
            },
            {
                path: 'multi',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_application_example-template-driven-forms_02-multi_exercice_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./02-multi/exercice.module */ 9707))
                    .then(mod => mod.ExerciceModule)
            },
            {
                path: 'init-class',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_application_example-template-driven-forms_03-init-class_exercice_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./03-init-class/exercice.module */ 5896))
                    .then(mod => mod.ExerciceModule)
            },
            {
                path: '',
...
//# sourceMappingURL=src_app_modules_application_example-template-driven-forms_tutorial_module_ts.js.map