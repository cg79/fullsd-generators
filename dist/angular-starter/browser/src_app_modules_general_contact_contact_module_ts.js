(self["webpackChunkcondition_mongo_query"] = self["webpackChunkcondition_mongo_query"] || []).push([["src_app_modules_general_contact_contact_module_ts"],{
...
const routes = [
    {
        path: '', component: _contact_component__WEBPACK_IMPORTED_MODULE_0__.ContactComponent, children: [
            {
                path: '',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_general_contact_mailing_mailing_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./mailing/mailing.module */ 1987))
            ...
            {
                path: 'map',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_general_contact_map_map_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./map/map.module */ 4426))
                    .then(m => m.MapModule)
            },
            {
                path: '**',
...
//# sourceMappingURL=src_app_modules_general_contact_contact_module_ts.js.map