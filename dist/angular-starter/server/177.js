...
class MqueryComponent {
  constructor() {
    ...
    this.script = null; // this.ref.detectChanges();

    this.dataModel = new _models_MongoDataModel__WEBPACK_IMPORTED_MODULE_0__.MongoDataModel(); // let script = this.document.createElement("script");
  ...
  sendEmail() {
    ...
    debugger; // const body = JSON.stringify({a:1})

    const body = {
      content: this.dataModel.emailBody
    };
    new _xhr_XhrService__WEBPACK_IMPORTED_MODULE_1__.XhrService().post(body, '/email').catch(ex => {
      console.log(ex);
    }).finally(() => {
...
MqueryComponent.ɵfac = function MqueryComponent_Factory(t) {
  return new (t || MqueryComponent)();
};

MqueryComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  type: MqueryComponent,
  selectors: [["app-mquery"]],
  decls: 62,
  vars: 4,
  consts: [["role", "banner", 1, "toolbar"], ["width", "80", "alt", "Mongo Logo", "src", "./assets/mongodb.png"], [1, "spacer"], [1, "mr10"], ["role", "main", 1, "content"], [1, "card-container", "flex"], ["type", "text", 1, "expression-input", 3, "ngModel", "ngModelChange"], [1, "content", "flex-center"], [1, "card", "highlight-card", "card-small", "flex-center", "generate", 3, "click"], ["id", "rocket", "src", "./assets/mongodb.svg", "alt", "mongo SVG"], [1, "generate"], [1, "card-container", "flex-center", "dircol"], [1, "dispflex"], [1, "bigspacer"]],
  template: function MqueryComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function MqueryComponent_Template_input_ngModelChange_9_listener($event) {
        return ctx.dataModel.expression = $event;
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MqueryComponent_Template_div_click_11_listener() {
        return ctx.dataModel.generateMongoExpression();
      });
